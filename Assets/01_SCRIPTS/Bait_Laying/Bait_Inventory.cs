...
public class Bait_Inventory : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            Baits trapStats = trapsItem[selectedSlotIndex].GetComponent<Baits>();
            string description = trapStats.description;
            string name = trapStats.trapName;
            int damages = trapStats.trapAndUpgrades[trapStats.upgradeIndex].GetComponent<Bait_Attack>().damages;
            float cooldownDamage = trapStats.trapAndUpgrades[trapStats.upgradeIndex].GetComponent<Bait_Attack>().cooldown;
            ...
            int cost = trapsItem[selectedSlotIndex].GetComponent<Baits>().costs[trapsItem[selectedSlotIndex].GetComponent<Baits>().upgradeIndex];
    ...
    public void UpdateInventory(GameObject trap, int _Index)
    {
        ...
        slots[_Index].sprite = trap.GetComponent<Baits>().ui_Image[0];
    ...
    {
        slots[_SlotIndex].sprite = trapsItem[_SlotIndex].GetComponent<Baits>().ui_Image[_UpIndex];
    }
